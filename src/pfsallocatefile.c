...
//#pragma GLOBAL_ASM("asm/nonmatchings/pfsallocatefile/osPfsAllocateFile.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/pfsallocatefile/__osPfsDeclearPage.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/pfsallocatefile/__osClearPage.s")
static s32 __osClearPage(OSPfs *pfs, int page_no, u8 *data, u8 bank)
{
    int i;
    s32 ret;
